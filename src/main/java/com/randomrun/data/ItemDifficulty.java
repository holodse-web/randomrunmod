...
public class ItemDifficulty {
    ...
    public static void initialize() {
        ...
        setDifficulty(Items.ENDER_PEARL, Difficulty.HARD);
        setDifficulty(Items.BLAZE_ROD, Difficulty.HARD);
        ...
        setDifficulty(Items.BOW, Difficulty.VERY_HARD);
        setDifficulty(Items.ENCHANTED_BOOK, Difficulty.VERY_HARD);
        
      
        setDifficulty(Items.TOTEM_OF_UNDYING, Difficulty.VERY_HARD);
        setDifficulty(Items.GHAST_TEAR, Difficulty.VERY_HARD);
        setDifficulty(Items.SHULKER_SHELL, Difficulty.VERY_HARD);
